...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/defberita.css'); ?>">
    <link rel="stylesheet" href="<?= base_url('assets/css/defapal.css'); ?>">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu bg-light" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item text-primary" href="<?= base_url('user/lintasan'); ?>">LINTASAN</a>
              <a class="dropdown-item text-primary" href="<?= base_url('user/pelabuhan'); ?>">PELABUHAN</a>
              <a class="dropdown-item text-primary" href="<?= base_url('user/kapal'); ?>">KAPAL</a>
            </div>
          </li>
          <li class="nav-item active">
